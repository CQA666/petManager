    ...
    <el-card class="login-card">
      <div class="card-content">
        ...
        <div class="login-image">
          <img src="../assets/小狗.jpg" alt="千锋智慧AI宠物管理平台" />
        ...
        <div class="form-container">
          ...
          <div class="title-container">
            <h1 class="main-title">千锋智慧AI宠物管理平台</h1>
            <p class="sub-title">Intelligent Pet</p>
            <br />
            <h2 class="login-greeting">欢迎登录</h2>
          </div>
          ...
          <!-- 登录表单：添加@submit.prevent阻止默认提交，输入框加.native修饰符 -->
          <el-form
              v-if="isLoginActive"
              ref="loginForm"
              :model="loginForm"
...
export default {
  ...
  methods: {
    ...
    handleGlobalEnter(e) {
      // 仅登录状态且按下回车键时触发
      if (this.isLoginActive && e.key === 'Enter') {
        this.onLogin();
      }
    },
    switchMode(mode) {
...
.login-wrapper {
  ...
  align-items: center;
  min-height: 100vh; /* 新增：让登录页垂直居中，避免页面过短 */
}
