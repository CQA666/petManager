<template>
    <div class="goods-container">
        ...
        <div class="goods-grid">
            <el-row :gutter="20">
                <el-col :xs="24" :sm="12" :md="6" :lg="6" v-for="product in productList" :key="product.id">
                    <div class="goods-card">
                        ...
                        <div class="goods-info">
                            ...
                            <el-tooltip v-if="product.desrc && product.desrc.length >= 40"
                            ...
                            <div class="purchase-section">
                                ...
                                <div class="total-price">
                                    总价: <span>{{ (product.price * (product.buyNum || 0)) | currency }}</span>
                                </div>
                            </div>
...
export default {
    ...
    methods: {
        ...
        addToCart(product) {
            ...
            request.post("/orders/save",this.orderInfo).then(res=>{
                if(res.code=='0'){
                    this.$message({
                        type:'success',
                        message: '订单创建成功!',
