    ...
    <div class="adopt-container">
        ...
        <div class="search-section">
            <el-form :inline="true" :model="searchForm" class="search-form">
                ...
                <el-form-item>
                    <el-select v-model="searchForm.type" placeholder="选择宠物类型" clearable>
        ...
        <div class="my-adopts" v-if="userInfo.role === 'USER'">
            <el-button type="primary" style="z-index: 9999;" @click="showMyAdopts" icon="el-icon-document">我的领养申请</el-button>
        </div>

        <!-- 宠物卡片区域 -->
        <div class="pet-grid">
            <el-row :gutter="20">
                <el-col :xs="24" :sm="12" :md="6" :lg="6" v-for="item in animalData" :key="item.id">
...
export default {
    ...
    methods: {
        ...
        showMyAdopts() {
            ...
            Request.get(`/adopt/user/${this.userInfo.id}`).then(res => {
                if (res.code === '0') {
        ...
        handleAdopt(animalId) {
            this.$confirm("确定要领养这只宠物吗？", "领养确认", {
                ...
                Request.post("/adopt/save", this.adoptForm).then(res => {
                    if (res.code === '0') {
