    ...
    <div class="logo">
      <div class="logo-container">
        <div class="icon-wrapper">
          <img src="/api/img/logo.png" class="logo-img" />
        </div>
        <div class="text-wrapper">
          <span class="logo-text">千锋AI智慧宠物</span>
...
export default {
  ...
  methods: {
    ...
    fetchNotifications() {
      ...
      Request.get(`/pet-notification/getPage`, {
        params: {
          userId: user.id,
          status: 'unread',
          currentPage: 1,
...
.logo-img {
  width: 80px;        /* 或 44px、48px，按需调整 */
  height: auto;
  margin: 0 6px;      /* 适当增加左右间距，避免拥挤 */
  display: block;
}
