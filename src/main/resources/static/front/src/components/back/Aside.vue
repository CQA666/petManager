        ...
        <div class="aside-logo">
            <div class="logo-container">
                ...
                <div class="text-wrapper">
                    <span class="logo-text">智慧宠物</span>
                    <span class="logo-subtitle">Intelligent Pet</span>
                </div>
            </div>
        </div>

        <div class="menu-container">
            <el-menu style="width: 220px;" default-active="dashboard" class="el-menu-vertical-demo" router
                background-color="white" text-color="rgb(77, 74, 74)">
...
.aside-logo::before {
    ...
    right: 0;
    bottom: 0;
    background: radial-gradient(circle at 30% 50%, rgba(58, 110, 165, 0.05) 0%, transparent 50%),
                radial-gradient(circle at 70% 50%, rgba(58, 110, 165, 0.05) 0%, transparent 50%);
    pointer-events: none;
}
