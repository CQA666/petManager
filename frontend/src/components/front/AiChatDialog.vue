    ...
    >
        <div class="chat-container">
            <div class="pet-selector">
                <el-select v-model="selectedPet" placeholder="请选择要对话的宠物" @change="handlePetChange">
                    <el-option
            ...
            <div class="chat-messages" ref="messageContainer">
                <div v-for="(msg, index) in chatMessages" :key="index"
                    ...
                    <el-avatar :size="40" :src="msg.isUser ? userAvatar : (selectedPetInfo ? HOST + '/' + selectedPetInfo.img : '')"></el-avatar>
                ...
                <div v-if="isLoading" class="message pet-message">
                    <el-avatar :size="40" :src="selectedPetInfo ? HOST + '/' + selectedPetInfo.img : ''"></el-avatar>
            ...
            <div class="chat-input">
                ...
                ></el-input>
                <el-button type="primary" @click="sendMessage" :disabled="!messageInput.trim() || !selectedPet">
                    发送消息
                </el-button>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        async sendMessage() {
            ...
            try {
                // 修改为使用 URL 参数形式发送请求
                const response = await Request.post(`/pet/ai/chat?userId=${this.userInfo.id}&petId=${this.selectedPet}&message=${encodeURIComponent(message)}`)
        ...
        .chat-messages {
            ...
            .message-content.loading {
                ...
                .dot {
                    ...
                    &:nth-child(3) { animation-delay: 0.64s; }
                }
            }
        }
